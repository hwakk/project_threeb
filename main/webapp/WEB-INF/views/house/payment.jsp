				...
				<div class="form-group">
					<div class="booking-charge">
						<div class="booking-house">
							<div class="house-img">
								<img src="${contextPath }/resources/image/house.jpg" alt="house_img">
							</div>
						...
						<div class="booking-total">
							<label class="float-left">총 합계(KRW)</label>
							<label class="float-right">₩&nbsp;<small id="amount_total">${house.house_charge * payMap.gap }</small></label>
