			...
			<div class="card bg-light mb-3">
				<div class="row no-gutters">
					...
					<div class="col-md-9 float-right">
						<div class="card-body">
							<h5 class="card-title">${house.house_title }</h5>
							<hr class="my-3">
						</div>
						<div class="card-body">
							<div class="card-body location">
								<p class="card-text location">${house.house_location }</p>
								<p class="card-text score">
									⭐&nbsp;&nbsp;${house.review_score }&nbsp;(${house.review_count })
								</p>
							</div>
							<div class="card-body button">
								...
								<a href="javascript:deleteHouse(${house.house_id })" class="btn btn-outline-danger btn-sm btn-cancel">
								삭제
								</a>
							</div>
						</div>
